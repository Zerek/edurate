...
{
    public class ExtendedFileExtensionsAttribute : DataTypeAttribute, IClientValidatable
    {
        private readonly FileExtensionsAttribute _innerAttribute =
            new FileExtensionsAttribute();

        /// <summary>
        ///     Initializes a new instance of the <see cref="ExtendedFileExtensionsAttribute" /> class.
        /// </summary>
        public ExtendedFileExtensionsAttribute()
